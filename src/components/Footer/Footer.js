        ...
        <footer className="text-gray-600 body-font">
                        ...
                        <nav className="list-none mb-10">
                            <li>
                                <a className="text-gray-500 hover:text-gray-800 inline-flex items-end" href="mailto:ayuda@tutolin.com.pe">
                                    ...
                                    <span className="ml-1 text-gray-600">ayuda@buscatuprofe.com.pe</span>
                                </a>
                            </li>
                            <li>
                                <a className="text-gray-500 hover:text-gray-800 inline-flex items-end" href="https://github.com/KoriAntunez/BuscaTuProfe_Front2">
                                    ...
                                    <span className="ml-1 text-gray-600">KoriAntunez/BuscaTuProfe_Front2</span>
                                </a>
                            </li>
                        </nav>
                    </div>
            ...
            <div className="bg-gray-100">
                <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    <p className="text-gray-500 text-sm text-center sm:text-left">© 2022 BuscaTuProfe. Todos los derechos reservados —
                        <a href="https://github.com/KoriAntunez/BuscaTuProfe_Front2" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">Desarrollado por Grupo 06</a>
                    </p>
                </div>
            </div>
        </footer>
